...
public class ModifyHopeEvent extends Event implements NameChangeListener {
	...
	public ModifyHopeEvent(Modification set) {
		//theitem=integerValueItem;
		mod=set;
		
		setIDName("changeValue hope");
		setName("change Value hope");
		//integerValueItem.addNameChangeListener(this);
	}
	public ModifyHopeEvent(Modification set,int modvalue) {
		//theitem=integerValueItem;
		mod=set;
	...
	public void trigger() {
		...
		control.performCommand(new ModifyIntegerValueCommand(modvalue,mod,itemcontrol.getHope()));
	}
	...
	public Univent copy() {
		return new ModifyHopeEvent(mod,modvalue);
	}
}
