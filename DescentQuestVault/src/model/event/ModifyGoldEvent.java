...
public class ModifyGoldEvent extends Event implements NameChangeListener {
	...
	public ModifyGoldEvent(Modification set) {
		//theitem=integerValueItem;
		mod=set;
		
		setIDName("changeValue gold");
		setName("change Value gold");
		//integerValueItem.addNameChangeListener(this);
	}
	public ModifyGoldEvent(Modification set,int modvalue) {
		//theitem=integerValueItem;
		mod=set;
		this.modvalue=modvalue;
		setIDName("changeValuegold");
		setName("change Value Gold");
		//integerValueItem.addNameChangeListener(this);
	}
	...
	public void trigger() {
		...
		control.performCommand(new ModifyIntegerValueCommand(modvalue,mod,itemcontrol.getGold()));
	}
