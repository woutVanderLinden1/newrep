...
public class ModifyFameEvent extends Event implements NameChangeListener{
	...
	public ModifyFameEvent(Modification set) {
		//theitem=integerValueItem;
		mod=set;
		
		setIDName("changeValue Fame");
		setName("change Value Fame");
		//integerValueItem.addNameChangeListener(this);
	}
	public ModifyFameEvent(Modification set,int modvalue) {
		//theitem=integerValueItem;
		mod=set;
	...
	public void trigger() {
		...
		control.performCommand(new ModifyIntegerValueCommand(modvalue,mod,itemcontrol.getFame()));
	}
