...
public class ModifyDespairEvent extends Event implements NameChangeListener {
	...
	public ModifyDespairEvent(Modification set) {
	...
	public ModifyDespairEvent(Modification set,int modvalue) {
		//theitem=integerValueItem;
		mod=set;
	...
	public void trigger() {
		...
		control.performCommand(new ModifyIntegerValueCommand(modvalue,mod,itemcontrol.getDespair()));
	}
