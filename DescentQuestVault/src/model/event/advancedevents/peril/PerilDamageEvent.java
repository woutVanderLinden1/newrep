...
public class PerilDamageEvent extends Event {

	private int perildamage;
	
	public PerilDamageEvent(int i) {
		perildamage=i;
		this.setName("Peril Damage");
		this.setIDName("PerilDamageEvent");
	}
	...
	public Univent copy() {
		// TODO Auto-generated method stub
		return new PerilDamageEvent(perildamage);
	}
